package com.company.transferObject;

import com.company.transferObject.core.StudentBO;
import com.company.transferObject.core.StudentVO;
 ...
 * 传输对象（Transfer Object） - 简单的 POJO，只有设置/获取属性的方法。 客户端（Client） -
 * 客户端可以发送请求或者发送传输对象到业务对象。
 * 
 * @author MGARY
 * @date 2019-11-29 下午5:32
 */
